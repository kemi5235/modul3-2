...
class Validate extends command_1.Command {
    async run() {
        ...
        const v = new validator_1.Validator((_a = flags.location) !== null && _a !== void 0 ? _a : process.cwd());
...
Validate.flags = {
    location: command_1.flags.string({ char: 'l', description: 'local folder or github repo url' }),
