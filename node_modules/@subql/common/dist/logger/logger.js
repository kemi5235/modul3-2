...
class Logger {
    constructor({ level: logLevel = 'info', nestedKey, outputFormat }) {
        this.childLoggers = {};
        this.pino = pino_1.default({
                ...
                ? {
                    payload: (value) => {
                        if (value instanceof Error) {
                            ...
                            return flatted_1.stringify(value);
                        }
                    },
                }
                : {},
            ...
            prettifier: function (options) {
                ...
                return function prettifier(inputData) {
                    ...
                    return `${time} <${colors_1.ctx.magentaBright(category)}> ${colors_1.colorizeLevel(level)} ${message} ${error}\n`;
                };
